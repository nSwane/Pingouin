...
public class FenDialogConfirmationQuitter extends JDialog implements ActionListener
{
  ...
  public FenDialogConfirmationQuitter(JFrame parent, String title, boolean modal)
  {
	  super(parent, title, modal);
	  this.mainFen = parent;
	  this.liaison = new Liaison(false,false);
  ...
  private void initComponent()
  {
	...
	public void actionPerformed(ActionEvent e) {
  	...
  	private void affichageTexte(JPanel panFenConfQuitter){
		...
		labelMessage2.setText("souhaitez-vous sauvegarder avant de quitter?");
